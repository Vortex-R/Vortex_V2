$(document).ready(function () {
  ...
  $(".register-btn").on("click", function () {
    $(".register-popup-wrap").addClass("active");
    return false;
  });
  $("html, body").on("click", function () {
    $(".register-popup-wrap").removeClass("active");
  });
  $(".register-popup-inner").on("click", function (event) {
    event.stopPropagation();
  });
  ...
  if ($.isFunction($.fn.slick)) {
    ...
    $(".feat-caro2").slick({
      ...
      pauseOnHover: false,
      prevArrow:
        "<button type='button' class='slick-prev'><i class='flaticon-arrow-pointing-to-left'></i>Prev Conference</button>",
      nextArrow:
        "<button type='button' class='slick-next'>Next Conference<i class='flaticon-trajectory'></i></button>",
    });
